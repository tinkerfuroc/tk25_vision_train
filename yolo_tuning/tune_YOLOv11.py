...
def plot_training_results(results_dir):
    ...
    # Plotting - adjust figure size for the new subplot
    ...
    # DFL Loss
    plt.subplot(2, 3, 3)
    plt.plot(epochs, results['train/dfl_loss'], label='Train DFL Loss')
    plt.plot(epochs, results['val/dfl_loss'], label='Validation DFL Loss')
...
def run_finetuning():
    ...
    ontology_path = os.getenv("ONTOLOGY_PATH", "src/vision_tuning/resource/ontology.json")
